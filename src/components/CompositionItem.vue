  ...
  <div class="mb-4 border-b border-gray-200 p-3 dark:border-gray-500">
    <div v-show="!showForm" class="flex justify-between">
      ...
      <div class="flex items-end gap-2">
        <button
          class="flex size-8 items-center justify-center rounded-sm bg-sky-600 text-sm text-white transition duration-500 hover:bg-sky-500"
        ...
        <button
          class="flex size-8 items-center justify-center rounded-sm bg-red-700 text-sm text-white transition duration-500 hover:bg-red-600"
